...
> Готовый к продакшену асинхронный микросервис для обработки международных платежей через Stripe.
...
- **SOLID** — Принципы единственной ответственности, открытости/закрытости, подстановки Лисков, разделения интерфейсов, инверсии зависимостей
- **DRY** — Не повторяйся
- **KISS** — Будь проще
